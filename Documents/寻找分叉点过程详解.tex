...
\begin{figure}[ht]
\centering
\includegraphics[width=0.8\textwidth]{simm}
\label{fig:sim}
\caption{简单情况}
\end{figure}
\item 复杂连通区域需要进行三步判断：
...
\centering
\subfigure[]{
\includegraphics[width=0.2\textwidth]{comp1}}
\hspace{1.5in}
\subfigure[]{
\includegraphics[width=0.2\textwidth]{comp2}}
\label{fig:com1}
\caption{第一步判断}
\end{figure}
...
\begin{figure}[ht!]
\centering
\includegraphics[width=0.3\textwidth]{coll}
\label{fig:coll}
\caption{第二步判断}
\end{figure}
...
\begin{figure}[ht!]
\centering
\includegraphics[width=0.4\textwidth]{comp3}
\label{fig:comp3}
\caption{第三步判断}
\end{figure}
\end{enumerate}
