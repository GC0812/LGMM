...
\centering
\subfigure[]{
\includegraphics[width=0.19\textwidth]{images/complex1}}
\hspace{0.3in}
\subfigure[]{
\includegraphics[width=0.5\textwidth]{images/complex6}}
\subfigure[]{
\includegraphics[width=0.26\textwidth]{images/complex5}}
\hspace{0.3in}
\subfigure[]{
\includegraphics[width=0.45\textwidth]{images/complex7}}
\caption{第一步判断}
\label{fig:complex1}
\end{figure}
